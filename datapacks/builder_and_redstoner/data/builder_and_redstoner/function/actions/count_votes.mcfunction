...
execute if score #current_team temp matches 0 as @a[team=!] if entity @s[team=!red] if score @s vote_player matches 1.. run scoreboard players add #red vote_count 1
...
execute if score #current_team temp matches 1 as @a[team=!] if entity @s[team=!orange] if score @s vote_player matches 1.. run scoreboard players add #orange vote_count 1
...
execute if score #current_team temp matches 2 as @a[team=!] if entity @s[team=!yellow] if score @s vote_player matches 1.. run scoreboard players add #yellow vote_count 1
...
execute if score #current_team temp matches 3 as @a[team=!] if entity @s[team=!green] if score @s vote_player matches 1.. run scoreboard players add #green vote_count 1
...
execute if score #current_team temp matches 4 as @a[team=!] if entity @s[team=!blue] if score @s vote_player matches 1.. run scoreboard players add #blue vote_count 1
...
execute if score #current_team temp matches 5 as @a[team=!] if entity @s[team=!purple] if score @s vote_player matches 1.. run scoreboard players add #purple vote_count 1
