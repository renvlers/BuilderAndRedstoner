execute unless items entity @s container.8 warped_fungus_on_a_stick[custom_data={item_type: "cancel_start_gameing"}] run item replace entity @s container.8 with warped_fungus_on_a_stick[ \
    item_name={text: "取消开始游戏", color: dark_red, bold: true}, \
    custom_data={item_type: "cancel_start_gaming"}, \
    item_model=barrier \
]
...
execute unless items entity @s container.2 air run item replace entity @s container.2 with air
execute unless items entity @s container.3 air run item replace entity @s container.3 with air
execute unless items entity @s container.4 air run item replace entity @s container.4 with air
execute unless items entity @s container.5 air run item replace entity @s container.5 with air
execute unless items entity @s container.6 air run item replace entity @s container.6 with air
